...
const LoginButton = () => {
  return (
    <ButtonLink to='/sign-in' id="login-button" className="btn d-flex align-items-center fs-6 fw-bold me-2 ms-sm-4">
      ...
      <span className='login-span d-inline ms-2'>Login</span>
    </ButtonLink>
  )
}
