  ...
  return (
    <footer className='d-flex justify-content-between align-items-center py-2 py-md-3 py-lg-3 px-3'>
      ...
      <div className='d-flex align-items-center'>  
        ...
        <a className='footer-link' href="https://www.youtube.com/" target='blank'>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-youtube mx-2" viewBox="0 0 16 16">
